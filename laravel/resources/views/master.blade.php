...
<body>
	<div class="edit-panel">
		<button id="quick-edit"><i class="fa fa-pencil-square-o"></i><p>Quick Edit</p></button>
		<a href="#" id="full-edit"><i class="fa fa-pencil"></i><p>Full Edit</p></a>
	</div>
